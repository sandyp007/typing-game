          ...
          <div className="footer-info text-center">
            <ul className="list-inline m-1">
              ...
              <li className="list-inline-item">
                <a
                  href="https://github.com/sandyp007/typing-game.git"
                  target="_blank"
                  title="GitHub"
                  rel="noopener noreferrer"
                >
              ...
              <li className="list-inline-item">
                <a
                  href="https://github.com/sandyp007/typing-game.git/issues"
                  target="_blank"
                  title="Issues"
                  rel="noopener noreferrer"
                >
            ...
            <div className="copyright">
              © 2024. Designed and built with
              <span role="img" aria-label="Heart">
                {" "}
                ❤️{" "}
              </span>
              by{" "}
              <a href="https://aboutmee.vercel.app/" title="SANDY">
                Sandy
              </a>{" "}
